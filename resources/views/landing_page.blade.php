...
<body class="font-nunito overflow-visible">
        ...
        "
            ...
            @if (Auth::check())
                <a href="{{ route('dashboard') }}"
                    class="px-14 rounded-lg py-2 bg-yellow-landing text-white ">Dashboard</a>
            @else
                <a href="{{ route('auth.login') }}"
                    class="px-14 rounded-lg py-2 bg-yellow-landing text-white ">Login</a>
            @endif

        </div>
        <div id="mobile_bar"
            class="active flex flex-col h-0 overflow-hidden justify-between font-semibold text-primary">
        ...
        <div class="flex lg:w-fit lg:space-x-2 space-x-4">
            <svg width="42" height="40" viewBox="0 0 42 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    ...
                    fill="#4267AD" />
                <path
                    d="M31.0448 21.6667C26.3828 21.6667 22.5991 25.4001 22.5991 30.0001C22.5991 34.6001 26.3828 38.3334 31.0448 38.3334C35.7068 38.3334 39.4905 34.6001 39.4905 30.0001C39.4905 25.4001 35.7068 21.6667 31.0448 21.6667ZM33.8319 33.9167L30.2002 30.3334V25.0001H31.8894V29.6501L35.0143 32.7334L33.8319 33.9167Z"
                    fill="#4267AD" />
            </svg>
            <div class="lg:max-w-[240px] max-w-[300px]">
                <h3 class="font-semibold text-base mb-2">Susah kelola waktu</h3>
                <p class="font-medium text-xs leading-6 flex items-center justify-center text-justify">Susah buat ngatur
    ...
    <div class="flex justify-center items-center h-[80vh] w-full  ">
        <div class=" w-full h-4/5 overflow-x-auto bg-primary">
            {{-- Content Profile --}}
            <div>
    ...
    <div class="px-12 py-14 bg-grey-landing flex flex-col items-center space-y-3">
        ...
        <p class=" w-[96%]  lg:w-3/5 text-dark-grey-landing text-center">Ga cuma yang ada di atas aja loh, kamu juga
            bisa tanya-tanya hal lain. Jadi gaperlu khawatir dan Psikolog di <span class="font-bold">DeepTalk</span>
            juga sudah teruji dan berpengalaman. Selesaikan <span class="font-bold">masalahmu</span>, dengan mencari
            jalan dan <span class="font-bold">memperbaikinya.</span></p>
    </div>
    <div class="flex flex-col items-center px-24 my-24 ">
        ...
        <div class="flex lg:flex-row flex-col justify-evenly w-full mt-24 space-y-7 lg:space-y-0">
            <div class="shadow-card_lp items-center flex flex-col py-4 rounded-2xl w-[300px] mx-auto">
                ...
                <p class="text-center  w-2/3 text-sm"><span class="font-bold">Login</span> menggunakan akun yang sudah
                    diberikan</p>
